...
export default memo(function AdmissionsModal({ isOpen, onClose, onShowToast }) {
      ...
      <div className="relative w-full max-w-4xl overflow-hidden rounded-[2.5rem] bg-white shadow-2xl grid md:grid-cols-2">
        ...
        <div className="relative hidden md:block bg-primary text-left">
          <img
            ...
            alt="Shri Kids Learning and Development"
          ...
          <div className="absolute bottom-10 left-10 right-10 text-white">
            <p className="font-sans text-2xl leading-snug font-black">Empowering young learners to explore, dream, and grow.</p>
            <p className="mt-2 text-sm text-white/70 font-bold">— Shri Kids Campus Life</p>
          </div>
        </div>
      </div>
    </div>
