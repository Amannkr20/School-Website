...
export default function Admissions({ onOpenAdmissions, onShowToast }) {
  const handleTalkToAdmissions = () => copyPhone(onShowToast);
      ...
      <section id="results" className="bg-white/70 py-16 lg:py-24 text-left">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-[2rem] bg-white p-7 shadow-[0_18px_50px_rgba(30,70,56,0.06)] border border-black/5">
              <p className="text-4xl font-display font-extrabold text-secondary">1000+</p>
              <p className="mt-2 text-sm uppercase tracking-[0.18em] text-dark/55">Happy Alumni</p>
            </div>
            <div className="rounded-[2rem] bg-white p-7 shadow-[0_18px_50px_rgba(30,70,56,0.06)] border border-black/5">
              <p className="text-4xl font-display font-extrabold text-poppy">10+ Yrs</p>
              <p className="mt-2 text-sm uppercase tracking-[0.18em] text-dark/55">Educational Legacy</p>
            </div>
            <div className="rounded-[2rem] bg-white p-7 shadow-[0_18px_50px_rgba(30,70,56,0.06)] border border-black/5">
              <p className="text-4xl font-display font-extrabold text-accent">100%</p>
              <p className="mt-2 text-sm uppercase tracking-[0.18em] text-dark/55">Safety &amp; Hygiene Rate</p>
            </div>
            <div className="rounded-[2rem] bg-white p-7 shadow-[0_18px_50px_rgba(30,70,56,0.06)] border border-black/5">
              <p className="text-4xl font-display font-extrabold text-leaf">20+</p>
            ...
            <div>
              ...
              <div className="mt-6 space-y-5">
                <div className="flex items-start gap-4 border-b border-white/10 pb-5">
                  <div className="shrink-0 rounded-2xl bg-white/10 px-4 py-3 text-center min-w-[70px]">
                ...
                <div className="flex items-start gap-4 border-b border-white/10 pb-5">
                  <div className="shrink-0 rounded-2xl bg-white/10 px-4 py-3 text-center min-w-[70px]">
                    <p className="text-xs uppercase tracking-[0.18em] text-poppy font-bold">Apr</p>
                ...
                <div className="flex items-start gap-4">
                  <div className="shrink-0 rounded-2xl bg-white/10 px-4 py-3 text-center min-w-[70px]">
                    <p className="text-xs uppercase tracking-[0.18em] text-leaf font-bold">Jun</p>
                    <p className="text-2xl font-extrabold leading-none mt-1">15</p>
                  </div>
                  <div className="min-w-0">
